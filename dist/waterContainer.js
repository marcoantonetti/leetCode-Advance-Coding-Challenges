...
const getMaxStorage = (heights) => {
    ...
    for (let i = 0; i < heights.length; i++) {
        ...
        for (let k = heights.length - 1; k >= 0; k--) {
            ...
            let storage = endPoint1 < endPoint2 ? distance * endPoint1 : distance * endPoint2;
...
const heightsArr = [1, 8, 6, 2, 5, 4, 8, 3, 7];
getMaxStorage(heightsArr);
//# sourceMappingURL=waterContainer.js.map